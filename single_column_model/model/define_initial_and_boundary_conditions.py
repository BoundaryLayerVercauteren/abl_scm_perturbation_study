...
def transfer_all_variables_to_fenics_functions(var1, var2, var3, var4, function_space_projection):
    var1 = transform_values.convert_numpy_array_to_fenics_function(var1, function_space_projection)
    var2 = transform_values.convert_numpy_array_to_fenics_function(var2, function_space_projection)
    var3 = transform_values.convert_numpy_array_to_fenics_function(var3, function_space_projection)
    var4 = transform_values.convert_numpy_array_to_fenics_function(var4, function_space_projection)
...
def define_initial_conditions(Q, mesh, params):
    ...
    return u_t0, v_t0, theta_t0, k_t0
