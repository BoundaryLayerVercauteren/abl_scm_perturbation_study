...
def combine_model_solver_functions(fenics_params, params, output):
    ...
    fenics_params, params = initial_and_boundary_conditions.def_boundary_conditions(fenics_params, params)

    # Define initial profiles/ values
    u_n, v_n, T_n, k_n = initial_and_boundary_conditions.def_initial_conditions(fenics_params.Q, mesh, params)
